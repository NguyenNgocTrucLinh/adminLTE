                            ...
                            <div className="col-md-6">
                                ...
                                <span className="contacts-list-name">
                                  ...
                                  <small className="contacts-list-date pull-right">2/28/2015</small>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img className="contacts-list-img" src="assets/dist/img/user7-128x128.jpg" alt="User Image" />
                                                        <div className="contacts-list-info">
                                <span className="contacts-list-name">
                                  Sarah Doe
                                  <small className="contacts-list-date pull-right">2/23/2015</small>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img className="contacts-list-img" src="assets/dist/img/user3-128x128.jpg" alt="User Image" />
                                                        <div className="contacts-list-info">
                                <span className="contacts-list-name">
                                  Nadia Jolie
                                  <small className="contacts-list-date pull-right">2/20/2015</small>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img className="contacts-list-img" src="assets/dist/img/user5-128x128.jpg" alt="User Image" />
                                                        <div className="contacts-list-info">
                                <span className="contacts-list-name">
                                  Nora S. Vans
                                  <small className="contacts-list-date pull-right">2/10/2015</small>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img className="contacts-list-img" src="assets/dist/img/user6-128x128.jpg" alt="User Image" />
                                                        <div className="contacts-list-info">
                                <span className="contacts-list-name">
                                  John K.
                                  <small className="contacts-list-date pull-right">1/27/2015</small>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img className="contacts-list-img" src="assets/dist/img/user8-128x128.jpg" alt="User Image" />
                                                        <div className="contacts-list-info">
                                <span className="contacts-list-name">
                                  Kenneth M.
