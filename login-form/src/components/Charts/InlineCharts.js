        ...
        <div className="content-wrapper">
            ...
            <section className="content">
                        ...
                        <div className="box box-solid">
                            <div className="box-header">
                                ...
                                <div className="box-tools pull-right">
                                    <button type="button" className="btn btn-default btn-sm" data-widget="collapse"><i
                                        className="fa fa-minus"/>
                                    </button>
                                    <button type="button" className="btn btn-default btn-sm" data-widget="remove"><i
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xs-6 col-md-3 text-center">
                                        <input type="text" className="knob" defaultValue={-80} data-min={-150}
                                               data-max={150} data-width={90} data-height={90} data-fgColor="#00a65a"/>
                ...
                <div className="callout callout-info">
                    ...
                    <p>The following three inline (sparkline) chart have been initialized to read and interpret data
                        tags</p>
                </div>
                {/* /.callout */}
                <div className="row">
                            ...
                            <div id="myBody" className="box-body">
                                <div className="row">
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <p>
                                            Box Plot: <span
                                            className="sparkboxplot">4,27,34,52,54,59,61,68,78,82,85,87,91,93,100</span><br/>
